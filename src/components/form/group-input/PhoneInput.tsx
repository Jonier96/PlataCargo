      ...
      {selectPosition === "start" && (
        <div className="absolute">
          <select
            ...
            className="appearance-none bg-none rounded-l-lg border-0 border-r border-gray-200 bg-transparent py-3 pl-3.5 pr-8 leading-tight text-gray-700 focus:border-green-300 focus:outline-none focus:ring focus:ring-green-500/10 dark:border-gray-800 dark:text-gray-400"
          >
      ...
      {selectPosition === "end" && (
        <div className="absolute right-0">
          <select
            value={selectedCountry}
            onChange={handleCountryChange}
            className="appearance-none bg-none rounded-r-lg border-0 border-l border-gray-200 bg-transparent py-3 pl-3.5 pr-8 leading-tight text-gray-700 focus:border-green-300 focus:outline-none focus:ring focus:ring-green-500/10 dark:border-gray-800 dark:text-gray-400"
          >
            {countries.map((country) => (
              <option
                key={country.code}
